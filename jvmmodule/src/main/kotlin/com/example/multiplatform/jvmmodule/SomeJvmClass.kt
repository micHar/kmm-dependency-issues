...
class SomeJvmClass {
    ...
    - but builds just fine when built from another multiplatform module
           (when the dependency on implementation(project(":multiplatformmodule")) is in
           commonMain of multiplatform module
